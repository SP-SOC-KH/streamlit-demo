...
# product_details = get_course_details(result_category_course)
...
def generate_response_based_on_course_details(user_message, product_details):
    ...
    Make sure to include {delimiter} to separate every step and exclude {delimiter} from the start and the end of the result 
    """
